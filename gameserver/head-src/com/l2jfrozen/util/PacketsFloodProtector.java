...
public class PacketsFloodProtector
{
	...
	private static Hashtable<String, AtomicInteger> clients_concurrent_actions = 
		new Hashtable<String, AtomicInteger>();
	
	private static final Logger _log = Logger.getLogger(PacketsFloodProtector.class.getName());
	
	private static Hashtable<String, Hashtable<Integer, AtomicInteger>> clients_actions = 
		new Hashtable<String, Hashtable<Integer, AtomicInteger>>();
	
	private static Hashtable<String, Hashtable<Integer, Integer>> clients_nextGameTick = 
		new Hashtable<String, Hashtable<Integer, Integer>>();

	private static Hashtable<String, Boolean> punishes_in_progress = 
