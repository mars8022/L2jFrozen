 ...
 */
package com.l2scoria.gameserver.ai.special.manager;

import java.util.logging.Logger;

import com.l2scoria.gameserver.ai.special.Antharas;
import com.l2scoria.gameserver.ai.special.Baium;
import com.l2scoria.gameserver.ai.special.Barakiel;
import com.l2scoria.gameserver.ai.special.Core;
import com.l2scoria.gameserver.ai.special.FairyTrees;
import com.l2scoria.gameserver.ai.special.Golkonda;
import com.l2scoria.gameserver.ai.special.Gordon;
import com.l2scoria.gameserver.ai.special.Hallate;
import com.l2scoria.gameserver.ai.special.IceFairySirra;
import com.l2scoria.gameserver.ai.special.Kernon;
import com.l2scoria.gameserver.ai.special.Monastery;
import com.l2scoria.gameserver.ai.special.QueenAnt;
import com.l2scoria.gameserver.ai.special.SummonMinions;
import com.l2scoria.gameserver.ai.special.Transform;
import com.l2scoria.gameserver.ai.special.VanHalter;
import com.l2scoria.gameserver.ai.special.VarkaKetraAlly;
import com.l2scoria.gameserver.ai.special.Zaken;
import com.l2scoria.gameserver.ai.special.ZombieGatekeepers;
