...
public final class L2WorldRegion
{
		...
		if(!isOn)
		{
			for(L2Object o : _visibleObjects)
			{
				if(o instanceof L2Attackable)
				{
					...
					mob.getAI().setIntention(com.l2scoria.gameserver.ai.CtrlIntention.AI_INTENTION_IDLE);
	...
	/**
	 * Add the L2Object in the L2ObjectHashSet(L2Object) _visibleObjects containing L2Object visible in this
	 * L2WorldRegion <BR>
