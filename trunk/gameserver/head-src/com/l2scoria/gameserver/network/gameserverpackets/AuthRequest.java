 ...
 */
package com.l2scoria.gameserver.network.gameserverpackets;
...
{
	/**
	 * Format: cccSddb c desired ID c accept alternative ID c reserve Host s ExternalHostName s InetranlHostName d max
	...
	/* (non-Javadoc)
	 * @see com.l2scoria.gameserver.gameserverpackets.GameServerBasePacket#getContent()
	 */
	@Override
