...
public class Zaken  extends Quest implements Runnable
{
	...
	public Zaken (int questId, String name, String descr)
	{
        ...
        for(int mob : mobs)
		{
			...
			this.addEventId(mob, Quest.QuestEventType.ON_SPAWN);
			this.addEventId(mob, Quest.QuestEventType.ON_SPELL_FINISHED);
			this.addEventId(mob, Quest.QuestEventType.ON_FACTION_CALL);
