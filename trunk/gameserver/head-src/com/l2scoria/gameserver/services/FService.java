...
public class FService
{
	...
	public static final String gof_CONFIG_FILE = "./config/gof/gof.properties";
	public static final String EVENT_CTF_FILE = "./config/gof/ctf.properties";
	public static final String EVENT_DM_FILE = "./config/gof/dm.properties";
	public static final String EVENT_TVT_FILE = "./config/gof/tvt.properties";
	public static final String EVENT_TW_FILE = "./config/gof/tw.properties";
