...
public class TaskShutdown extends Task
{
	...
	/* (non-Javadoc)
	 * @see com.l2scoria.gameserver.taskmanager.Task#getName()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2scoria.gameserver.taskmanager.Task#onTimeElapsed(com.l2scoria.gameserver.taskmanager.TaskManager.ExecutedTask)
	 */
	@Override
