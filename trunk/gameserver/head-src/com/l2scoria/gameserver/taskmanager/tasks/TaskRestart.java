...
public final class TaskRestart extends Task
{
	...
	/* (non-Javadoc)
	 * @see com.l2scoria.gameserver.tasks.Task#getName()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.l2scoria.gameserver.tasks.Task#onTimeElapsed(com.l2scoria.gameserver.tasks.TaskManager.ExecutedTask)
	 */
	@Override
