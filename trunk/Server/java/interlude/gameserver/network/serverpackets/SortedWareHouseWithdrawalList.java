...
import interlude.gameserver.templates.L2WarehouseItem;
...
public class SortedWareHouseWithdrawalList extends L2GameServerPacket
{
	 ...
	 * @param type
	 *            is the Warehouse Type
	 * @param itemtype
	 *            is the Itemtype to sort for
	 * @param sortorder
	 *            is the integer Sortorder like 1 for A..Z (use public constant)
	 */
