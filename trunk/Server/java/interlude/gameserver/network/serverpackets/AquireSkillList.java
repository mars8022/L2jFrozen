...
public class AquireSkillList extends L2GameServerPacket
{
	...
	{
		writeC(0x8a);
		writeD(_fishingSkills.ordinal()); // c4 : C5 : 0: usuall 1:
		// fishing 2:
		// clans
		writeD(_skills.size());
