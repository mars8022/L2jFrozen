...
public final class RequestPackageSend extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		try {
			...
			if (warehouse instanceof PcFreight && Config.GM_DISABLE_TRANSACTION && player.getAccessLevel() >= Config.GM_TRANSACTION_MIN && player.getAccessLevel() <= Config.GM_TRANSACTION_MAX && !player.isGM())
			{
