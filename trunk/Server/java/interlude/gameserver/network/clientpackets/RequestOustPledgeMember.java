...
import interlude.gameserver.network.serverpackets.PledgeShowMemberListDelete;
...
public final class RequestOustPledgeMember extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		clan.removeClanMember(_target, System.currentTimeMillis() + Config.ALT_CLAN_JOIN_DAYS * 86400000L); // 24*60*60*1000
		// =
		// 86400000
		clan.setCharPenaltyExpiryTime(System.currentTimeMillis() + Config.ALT_CLAN_JOIN_DAYS * 86400000L); // 24*60*60*1000
		// =
		// 86400000
		clan.updateClanInDB();
