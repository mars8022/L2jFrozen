...
import interlude.gameserver.model.AutoSpawnHandler;
import interlude.gameserver.model.L2World;
import interlude.gameserver.model.AutoSpawnHandler.AutoSpawnInstance;
...
public class SevenSigns
{
	...
	// The quest event and seal validation periods last for approximately
	// one
	// week
	...
	protected void calcNewSealOwners()
	{
		...
		for (Integer currSeal : _signsDawnSealTotals.keySet())
		{
			...
			/*
			 * - If a Seal was already closed or owned by the opponent and the new winner wants to assume ownership of the Seal, 35% or more of the members of the Cabal must have chosen the Seal. If they chose less than 35%, they cannot own the Seal. - If the Seal was owned by the winner in the previous Seven Signs, they can retain that seal if 10% or more members have chosen it. If they want to
			 * possess a new Seal, at least 35% of the members of the Cabal must have chosen the new Seal.
			 */
