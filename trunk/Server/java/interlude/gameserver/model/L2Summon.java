...
import interlude.gameserver.ai.L2SummonAI;
...
import interlude.gameserver.model.actor.knownlist.SummonKnownList;
import interlude.gameserver.model.actor.stat.SummonStat;
import interlude.gameserver.model.actor.status.SummonStatus;
...
import interlude.gameserver.network.serverpackets.PetDelete;
import interlude.gameserver.network.serverpackets.PetInfo;
import interlude.gameserver.network.serverpackets.PetStatusShow;
import interlude.gameserver.network.serverpackets.PetStatusUpdate;
...
public abstract class L2Summon extends L2PlayableInstance
{
	...
	// Logger.getLogger(L2Summon.class.getName());
	...
	private boolean _isInRange = true;
