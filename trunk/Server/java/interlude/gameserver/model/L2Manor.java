...
public class L2Manor
{
	...
	private SeedData parseList(String line)
	{
		...
		int matureId = Integer.parseInt(st.nextToken()); // mature crop
		// id
		...
		int limitSeeds = Integer.parseInt(st.nextToken()); // limit for
		// seeds
		int limitCrops = Integer.parseInt(st.nextToken()); // limit for
		// crops
