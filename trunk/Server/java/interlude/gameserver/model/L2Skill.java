...
import interlude.gameserver.skills.l2skills.L2SkillCharge;
import interlude.gameserver.skills.l2skills.L2SkillChargeDmg;
import interlude.gameserver.skills.l2skills.L2SkillCreateItem;
import interlude.gameserver.skills.l2skills.L2SkillDefault;
import interlude.gameserver.skills.l2skills.L2SkillDrain;
import interlude.gameserver.skills.l2skills.L2SkillExitBuffs;
import interlude.gameserver.skills.l2skills.L2SkillNeedCharge;
import interlude.gameserver.skills.l2skills.L2SkillSeed;
...
public abstract class L2Skill implements IChanceSkillTrigger
{
	...
	{
		// Damage
		PDAM, MDAM, CPDAM, MANADAM, DOT, MDOT, DRAIN_SOUL, DRAIN(L2SkillDrain.class), DEATHLINK, BLOW, FATALCOUNTER,
		// Disablers
		BLEED, POISON, STUN, ROOT, CONFUSION, FEAR, SLEEP, CONFUSE_MOB_ONLY, MUTE, PARALYZE, WEAKNESS,
		// hp, mp, cp
		HEAL, HOT, BALANCE_LIFE, HEAL_PERCENT, HEAL_STATIC, COMBATPOINTHEAL, CPHOT, MANAHEAL, MANA_BY_LEVEL, MANAHEAL_PERCENT, MANARECHARGE, MPHOT, COMBATPOINTPERHEAL,
		// Give Sp
		GIVE_SP, MOG,
		// Aggro
		...
		// MISC
		UNLOCK, ENCHANT_ARMOR, ENCHANT_WEAPON, SOULSHOT, SPIRITSHOT, SIEGEFLAG, TAKECASTLE, WEAPON_SA, DELUXE_KEY_UNLOCK, SOW, HARVEST, GET_PLAYER,
		// Creation
		COMMON_CRAFT, DWARVEN_CRAFT, CREATE_ITEM(L2SkillCreateItem.class), SUMMON_TREASURE_KEY,
		// Summons
	...
	public final L2Object[] getTargetList(L2Character activeChar, boolean onlyFirst)
	{
		...
		switch (targetType)
		{
			...
			{
				if (target != null && target == activeChar || target != null && activeChar.getParty() != null && target.getParty() != null && activeChar.getParty().getPartyLeaderOID() == target.getParty().getPartyLeaderOID() || target != null && activeChar instanceof L2PcInstance && target instanceof L2Summon && activeChar.getPet() == target
						...
						if (getSkillType() == SkillType.RESURRECT)
						{
							...
							if (targetPlayer != null)
							{
								if (targetPlayer.isReviveRequested())
								{
									...
									{
										player.sendPacket(new SystemMessage(SystemMessageId.MASTER_CANNOT_RES)); // While
										// a
										// pet
										// is
										// attempting
									...
									{
										player.sendPacket(new SystemMessage(SystemMessageId.RES_HAS_ALREADY_BEEN_PROPOSED)); // Resurrection
									}
									// is
									// already
									// been
