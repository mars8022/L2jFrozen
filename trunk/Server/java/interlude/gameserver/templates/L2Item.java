...
public abstract class L2Item
{
	...
	protected L2Item(Enum type, StatsSet set)
	{
		...
		_type1 = set.getInteger("type1"); // needed for item list
		// (inventory)
		_type2 = set.getInteger("type2"); // different lists for armor,
		// weapon, etc
	...
	public final void setCrystallizable(boolean value)
	{
		_crystallizable = value;
	}
	...
	public final void setSellable(boolean value)
	{
		_sellable = value;
	}
	...
	public final void setDropable(boolean value)
	{
		_dropable = value;
	}
	...
	public final void setDestroyable(boolean value)
	{
		_destroyable = value;
	}
