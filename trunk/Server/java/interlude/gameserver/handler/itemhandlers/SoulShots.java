...
import interlude.gameserver.network.serverpackets.ExAutoSoulShot;
...
public class SoulShots implements IItemHandler
{
	...
	public void useItem(L2PlayableInstance playable, L2ItemInstance item)
	{
		...
		try
		{
			...
			if (!Config.ENDLESS_SOUL_SHOTS && !activeChar.destroyItemWithoutTrace("Consume", item.getObjectId(), SSCount, null, false))
			{
				if (activeChar.getAutoSoulShot().containsKey(itemId))
				{
