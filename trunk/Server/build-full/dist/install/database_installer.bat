...
goto start
:createVars
echo Welcome to L2Open Opensource Installer version 0.2
echo You are trying to install L2Open datapack.Please configure it if its your first time
echo.
...
set /P lsdb="Database (default is 'l2open'): "
...
set /P gsdb="Database (default is 'l2open'): "
