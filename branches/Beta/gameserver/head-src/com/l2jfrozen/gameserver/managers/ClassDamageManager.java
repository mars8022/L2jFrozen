...
public class ClassDamageManager
{
	...
	public static void loadConfig()
	{
		...
		try
		{
			...
			/*int class_id = 114;
			LOGGER.info("class: "+id_to_name.get(class_id)+" classid: "+class_id);
			LOGGER.info("multiplier to fighter: "+damage_to_fighter.get(class_id));
			LOGGER.info("multiplier to mage: "+damage_to_mage.get(class_id));
			LOGGER.info("multiplier by fighter: "+damage_by_fighter.get(class_id));
			LOGGER.info("multiplier by mage: "+damage_by_mage.get(class_id));
			*/
		}
		catch(Exception e)
		{
