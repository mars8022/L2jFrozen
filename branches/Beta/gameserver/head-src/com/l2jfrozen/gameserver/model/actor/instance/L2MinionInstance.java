...
/**
 * This class manages all Minions. In a group mob, there are one master called RaidBoss and several slaves called
 * Minions.
 * 
...
{
	//private static Logger LOGGER = Logger.getLogger(L2RaidMinionInstance.class.getClass());
	 ...
	 * <B><U> Actions</U> :</B><BR>
	 * <BR>
	 * <li>Call the L2Character constructor to set the _template of the L2MinionInstance (copy skills from template to
