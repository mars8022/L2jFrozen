...
{
	/**
	 * ID: 1 Message: The server will be coming down in [x] second(s). Please find the safe place to log out. On Screen Text: Exit Game [x] second(s).
	 */
	...
	/**
	 * ID: 1054<br>
	 * Message: It is not possible to use this Equipment Restriction.
	 */
	CANNOT_EQUIP_ITEM_DUE_TO_BAD_CONDITION(1054),
	/**
	 * ID: 337<br>
	...
	// /**
	// * ID: 1288<br>
	// * Message: If trends continue, $s1 will win and the seal will belong
	// to:
	// */
	...
	/**
	 * ID: 1271<br>
	 * Message: Message for reflect CounterAttack.
	 */
	S1_IS_PERFORMING_A_COUNTER_ATTACK(1271),
	/**
	 * ID: 1269<br>
	...
	/**
	 * ID: 1667<br>
	 * Message: Instant kill.
	 */
	INSTANT_KILL(1667),
	/**
	 * ID: 1668<br>
	 * Message: You have been struck by the instant kill skill.
	 */
	YOU_HAVE_BEEN_STRUCK_BY_THE_INSTANT_KILL_SKILL(1668),
	/**
	 * ID: 1685<br>
	 * Message: You are unable to equip this item when your PK count is greater than or equal to one.
	 */
	UNABLE_TO_EQUIP_ITEM_WHEN_PK_COUNT_GREATER_OR_EQUAL_THAN_ONE(1685),
	/**
	 * L2 Manor<br>
