...
import interlude.gameserver.network.clientpackets.*;
			...
			case IN_GAME:
				switch (opcode)
				{
					...
					case 0x0f:
						...
						break;
					// case 0x10:
					// // RequestEquipItem ... not used any more, instead
					// "useItem"
					// break;
					case 0x11:
					...
					// // Ride
					// break;
					case 0x6b: // send when talking to trainer npc, to show
					...
					case 0xab:
						msg = new SnoopQuit();
						break;
					case 0xac: // we still need this packet to handle BACK
						// button of craft dialog
...
//						break;
					...
					case 0xcd:
						...
						break;
					case 0xce: // MSN dialogs so that you dont see them in the
						// console.
						break;
