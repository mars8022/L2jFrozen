...
public final class RequestSellItem extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		for (int i = 0; i < _count; i++)
		{
			...
			/*
			 * TODO: Disabled until Leaseholders are rewritten ;-) int price = item.getReferencePrice()(int)count/2; L2ItemInstance li = null; L2ItemInstance la = null; if (_listId > 1000000) { li = merchant.findLeaseItem(item.getItemId(),item.getEnchantLevel()); la = merchant.getLeaseAdena(); if (li == null || la == null) continue; price = li.getPriceToBuy()(int)count; // player sells, thus
			 * merchant buys. if (price > la.getCount()) continue; }
			 */
			/*
