 ...
 */
package interlude.gameserver.ai2;
...
import interlude.gameserver.ai2.AiInstance.QueueEventRunner;
		...
		try
		{
			...
			for (String file : directory.list())
			{
				if (file.endsWith(".class"))
				{
					try
					{
						Class managerClass = Class.forName("interlude.gameserver.ai.managers." + file.substring(0, file.length() - 6));
						...
						for (EventHandler handler : managerInstance.getEventHandlers())
						{
							...
							// let's check if any previously created
							// AiInstance
							// is allready used for the NPC concerned by
							// this
							// handler
							...
							for (Intersection i : intersections)
							{
								...
								i.ai.getPluginingParamaters().removeIDs(i.ids); // TODO
								// if
								// this
								// is
								// extracted
								...
								// to
								// AiIntances
								// create a new instance with the secant ids
								// that will inherit all the handlers from the
								// secant Ai
