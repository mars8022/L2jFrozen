...
public class SkillTreeTable
{
	...
	private List<L2SkillLearn> _fishingSkillTrees; // all common skills
	// (teached by Fisherman)
	private List<L2SkillLearn> _expandDwarfCraftSkillTrees; // list of
	// special
	// skill for dwarf
	// (expand dwarf
	// craft) learned by
	...
	private List<L2EnchantSkillLearn> _enchantSkillTrees; // enchant skill
	...
	public L2SkillLearn[] getAvailableSkills(L2PcInstance cha, ClassId classId)
	{
		...
		if (skills == null)
		{
			// the skilltree for this class is undefined, so we give an
			// empty
			// list
