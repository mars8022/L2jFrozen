...
package interlude.gameserver.model.olympiad;
...
import interlude.gameserver.instancemanager.OlympiadStadiaManager;
...
import interlude.gameserver.network.serverpackets.ExOlympiadUserInfoSpectator;
...
public class Olympiad
{
    ...
    private static final String OLYMPIAD_DATA_FILE = "config/custom/Olympiad.ini";
    ...
    private class OlympiadManager implements Runnable
    {
        ...
        private void sortClassBasedOpponents()
        {
            ...
            for (List<L2PcInstance> classed : _classBasedRegisters.values())
            {
                if (classed.size() == Config.ALT_OLY_CLASSED) continue;
    	...
    	protected void removals()
    	{
    		...
    		for (L2PcInstance player : _players)
    		{
    		  try
    		  {
				...
				if (wpn != null && wpn.getItemId() >= 6611 && wpn.getItemId() <= 6621 
								|| wpn.getItemId() == 6842 
								|| wpn.getItemId() == 5597 
								|| wpn.getItemId() == 5605 
								|| wpn.getItemId() == 6314 
