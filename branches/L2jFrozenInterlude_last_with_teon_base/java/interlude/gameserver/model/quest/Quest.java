 ...
 */
package interlude.gameserver.model.quest;
...
import interlude.gameserver.scripting.ManagedScript;
import interlude.gameserver.scripting.ScriptManager;
import interlude.gameserver.templates.L2NpcTemplate;
import interlude.gameserver.util.Rnd;
...
public class Quest extends ManagedScript
{
	...
	/**
	 * @see interlude.gameserver.scripting.ManagedScript#getScriptName()
	 */
	@Override
	...
	/**
	 * @see interlude.gameserver.scripting.ManagedScript#setActive(boolean)
	 */
	@Override
	...
	/**
	 * @see interlude.gameserver.scripting.ManagedScript#reload()
	 */
	@Override
	...
	/**
	 * @see interlude.gameserver.scripting.ManagedScript#unload()
	 */
	@Override
	...
	/**
	 * @see interlude.gameserver.scripting.ManagedScript#getScriptManager()
	 */
	@Override
