...
public class CursedWeapon
{
	...
	public void endOfLife()
	{
		...
		{
			// either this cursed weapon is in the inventory of someone who
			// has
	...
	private void dropIt(L2Attackable attackable, L2PcInstance player, L2Character killer, boolean fromMonster)
	{
		...
		else
		{
			...
			// _player.getInventory().dropItem("DieDrop", item, _player,
			// null);
	...
	public void cursedOnLogin()
	{
		...
		msg.addItemName(_player.getCursedWeaponEquipedId());
