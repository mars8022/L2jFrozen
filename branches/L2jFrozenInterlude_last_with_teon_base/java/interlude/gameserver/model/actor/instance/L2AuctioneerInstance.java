...
import interlude.gameserver.model.entity.Auction;
import interlude.gameserver.model.entity.Auction.Bidder;
...
public final class L2AuctioneerInstance extends L2FolkInstance
{
	...
	public void showMessageWindow(L2PcInstance player)
	{
		...
		int condition = validateCondition(player);
		if (condition == COND_BUSY_BECAUSE_OF_SIEGE) {
			filename = "data/html/auction/auction-busy.htm"; // Busy because
		// of siege
		} else {
