		...
		else if (command.startsWith("SevenSigns"))
		{
			...
			switch (val)
			{
				...
				case 4: // Join a Cabal - SevenSigns 4 [0]1 x
					...
					// Dusk
					// Show a confirmation message to the user, indicating
					// which seal they chose.
					switch (newSeal)
					{
				...
				case 11: // Teleport to Hunting Grounds
					...
					break;
				case 17: // Exchange Seal Stones for Ancient Adena (Type
					// Choice) - SevenSigns 17 x
					...
					break;
				case 18: // Exchange Seal Stones for Ancient Adena -
					// SevenSigns 18 xxxx xxxxxx
