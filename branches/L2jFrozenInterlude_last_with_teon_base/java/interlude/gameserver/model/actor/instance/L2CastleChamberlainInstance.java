...
import interlude.gameserver.network.serverpackets.ExShowCropSetting;
...
import interlude.gameserver.network.serverpackets.ExShowSeedSetting;
...
public class L2CastleChamberlainInstance extends L2FolkInstance
{
	...
	public void onBypassFeedback(L2PcInstance player, String command)
	{
		...
		if (player.getLastFolkNPC().getObjectId() != this.getObjectId()) return;
