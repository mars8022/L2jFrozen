...
public class AdminLevel implements IAdminCommandHandler
{
	...
	private static final String[][] ADMIN_COMMANDS = { { "admin_remlevel", // remove level amount from your target
			...
			"Add a level amount to your target (player or pet).", "Usage: addlevel <num>", "Options:", "num - amount of levels to add/remove", }, { "admin_setlevel",  "admin_set_level", // set level of your target
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		if (cmd.equals("admin_addlevel") || cmd.equals("admin_setlevel") || cmd.equals("admin_set_level") || cmd.equals("admin_remlevel"))
		{
			int reslevel = 0;
			int curlevel = 0;
			long xpcur = 0;
