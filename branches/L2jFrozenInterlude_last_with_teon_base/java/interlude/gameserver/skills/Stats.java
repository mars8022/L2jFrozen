...
public enum Stats
{
	...
	// HP & MP
	MAX_HP("maxHp"), MAX_MP("maxMp"), MAX_CP("maxCp"), REGENERATE_HP_RATE("regHp"), REGENERATE_CP_RATE("regCp"), REGENERATE_MP_RATE("regMp"), RECHARGE_MP_RATE("gainMp"), HEAL_EFFECTIVNESS("gainHp"),
	// Atk & Def
	POWER_DEFENCE("pDef"), MAGIC_DEFENCE("mDef"), POWER_ATTACK("pAtk"), MAGIC_ATTACK("mAtk"), POWER_ATTACK_SPEED("pAtkSpd"), MAGIC_ATTACK_SPEED("mAtkSpd"), // how fast a spell is casted (including animation)
	MAGIC_REUSE_RATE("mReuse"), // how fast spells becomes ready to reuse
	P_REUSE("pReuse"), SHIELD_DEFENCE("sDef"), CRITICAL_DAMAGE("cAtk"), PVP_PHYSICAL_DMG("pvpPhysDmg"), PVP_MAGICAL_DMG("pvpMagicalDmg"), PVP_PHYS_SKILL_DMG("pvpPhysSkillsDmg"), REFLECT_DAMAGE_PHYSIC("DDT_PhysDmgReflect"), REFLECT_DAMAGE_MAGIC("DDT_MagicDmgReflect"), REFLECT_REVENGE_SKILL("DDT_ShieldRevenge"),
	// Atk & Def rates
	EVASION_RATE("rEvas"), REFLECT_SKILL_MELEE_PHYSIC("reflectSkillMeleePhysic"), SHIELD_RATE("rShld"), CRITICAL_RATE("rCrit"), BLOW_RATE("blowRate"), LETHAL_RATE("lethalRate"), MCRITICAL_RATE("mCritRate"), EXPSP_RATE("rExp"), ATTACK_CANCEL("cancel"), CANCEL_ATTACKER_TARGET("cancelAttackerTarget"),
	// Accuracy and range
	...
	// Special stats, share one slot in Calculator stats of various abilities
	P_SKILL_EVASION("pSkillEvas"), CRITICAL_DAMAGE_BONUS("cAtkBonus"), BREATH("breath"), AGGRESSION("aggression"), // locks a mob on tank caster
	...
	// C4 Stats
	MP_CONSUME_RATE("MpConsumeRate"), HP_CONSUME_RATE("HpConsumeRate"), DANCE_MP_CONSUME_RATE("DanceMpConsumeRate"), MP_CONSUME("MpConsume"), SOULSHOT_COUNT("soulShotCount");
