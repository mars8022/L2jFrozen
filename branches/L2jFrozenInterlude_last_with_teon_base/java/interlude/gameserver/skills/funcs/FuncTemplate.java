 ...
 */
package interlude.gameserver.skills.funcs;
...
public final class FuncTemplate
{
	...
	public FuncTemplate(Condition pAttachCond, Condition pApplayCond, String pFunc, Stats pStat, int pOrder, Lambda pLambda)
	{
		...
		try
		{
			func = Class.forName("interlude.gameserver.skills.funcs.Func" + pFunc);
		}
		...
		try
		{
			constructor = func.getConstructor(new Class[] { Stats.class, // stats
					// to
					// update
