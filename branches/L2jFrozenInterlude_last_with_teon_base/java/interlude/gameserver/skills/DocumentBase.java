 ...
 */
package interlude.gameserver.skills;
...
import interlude.gameserver.skills.conditions.Condition;
import interlude.gameserver.skills.conditions.ConditionElementSeed;
import interlude.gameserver.skills.conditions.ConditionForceBuff;
import interlude.gameserver.skills.conditions.ConditionGameChance;
import interlude.gameserver.skills.conditions.ConditionGameTime;
import interlude.gameserver.skills.conditions.ConditionLogicAnd;
import interlude.gameserver.skills.conditions.ConditionLogicNot;
import interlude.gameserver.skills.conditions.ConditionLogicOr;
import interlude.gameserver.skills.conditions.ConditionPlayerHp;
import interlude.gameserver.skills.conditions.ConditionPlayerHpPercentage;
import interlude.gameserver.skills.conditions.ConditionPlayerLevel;
import interlude.gameserver.skills.conditions.ConditionPlayerMp;
import interlude.gameserver.skills.conditions.ConditionPlayerRace;
import interlude.gameserver.skills.conditions.ConditionPlayerState;
import interlude.gameserver.skills.conditions.ConditionSkillStats;
import interlude.gameserver.skills.conditions.ConditionSlotItemId;
import interlude.gameserver.skills.conditions.ConditionTargetAggro;
import interlude.gameserver.skills.conditions.ConditionTargetClassIdRestriction;
import interlude.gameserver.skills.conditions.ConditionTargetLevel;
import interlude.gameserver.skills.conditions.ConditionTargetRaceId;
import interlude.gameserver.skills.conditions.ConditionTargetUsesWeaponKind;
import interlude.gameserver.skills.conditions.ConditionUsingItemType;
import interlude.gameserver.skills.conditions.ConditionUsingSkill;
import interlude.gameserver.skills.conditions.ConditionWithSkill;
import interlude.gameserver.skills.conditions.ConditionGameTime.CheckGameTime;
import interlude.gameserver.skills.conditions.ConditionPlayerState.CheckPlayerState;
import interlude.gameserver.skills.effects.EffectChanceSkillTrigger;
import interlude.gameserver.skills.effects.EffectTemplate;
import interlude.gameserver.skills.funcs.FuncTemplate;
import interlude.gameserver.skills.funcs.Lambda;
import interlude.gameserver.skills.funcs.LambdaCalc;
import interlude.gameserver.skills.funcs.LambdaConst;
import interlude.gameserver.skills.funcs.LambdaStats;
...
abstract class DocumentBase
{
	...
	protected void attachEffect(Node n, Object template, Condition attachCond)
	{
        ...
        lt = new EffectTemplate(attachCond, applayCond, name, lambda, count, time, abnormal, stackType, stackOrder, icon, trigId, trigLvl, chance);
		parseTemplate(n, lt);
		if (template instanceof L2Item) {
	...
	protected void attachSkill(Node n, Object template, Condition attachCond)
	{
		...
		if (template instanceof L2Weapon)
		{
			...
			if (attrs.getNamedItem("onCrit") != null) {
				((L2Weapon) template).attachOnCrit(skill); // Attach as
			}
			// skill
			// triggered on
			// critical hit
			if (attrs.getNamedItem("onCast") != null) {
				((L2Weapon) template).attachOnCast(skill); // Attach as
			// skill
			// triggered on cast
			}
		}
		...
		{
			((L2Item) template).attach(skill); // Attach as skill triggered
			// on use
		}
	}
