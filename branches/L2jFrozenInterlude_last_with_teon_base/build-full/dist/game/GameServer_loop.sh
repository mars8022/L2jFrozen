...
do
        ...
        java -Dfile.encoding=UTF-8 -Xms512m -Xmx2048m -XX:+UseParallelGC -XX:+AggressiveOpts -cp ./libs/*:l2open-game.jar interlude.gameserver.GameServer > log/stdout.log 2>&1
        sleep 10;
done
