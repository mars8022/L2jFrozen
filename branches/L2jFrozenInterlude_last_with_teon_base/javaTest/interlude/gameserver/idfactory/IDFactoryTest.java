...
import interlude.Config.IdFactoryType;
...
public class IDFactoryTest extends TestCase
{
    ...
    protected AtomicInteger _count = new AtomicInteger(0),
	    _adds = new AtomicInteger(0), _removes = new AtomicInteger(0);
	 ...
	 * startMemoryUse ) / (1024*1024); System.out.println("Size:
	 * "+approximateSize+"Mb.");
	 */
    }
    ...
    /*
     * Test method for
     * 'interlude.gameserver.idfactory.IdFactory.getNextId()'
     */
	...
	public void run()
	{
	    ...
	    if (_debug)
		System.out.println(getName() + " myCount is " + _myCount.get() + "/100.");
	    _latch.countDown();
	}
    }
	...
	public void run()
	{
	    ...
	    if (_debug)
		System.out.println(getName() + " count is " + _myCount.get() + "/100.");
	    _latch.countDown();
	}
    }
